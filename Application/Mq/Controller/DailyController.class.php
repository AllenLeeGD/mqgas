...
class DailyController extends Controller {
	...
	public function savecarsdaily(){
		$obj = getObjFromPost(array("dailydate","carid","carnumber","did","dname","pid","pname","sid","sname","yid","yname","carcourse","oilprice","cost","remark"));
	...
	public function editcarsdaily(){
		$obj = getObjFromPost(array("pkid","dailydate","carid","carnumber","did","dname","pid","pname","sid","sname","yid","yname","carcourse","oilprice","cost","remark"));
		$obj['dailydate'] = strtotime($obj['dailydate']);
		$pkid = $obj["pkid"];
		$dao = M("Carsdaily");
