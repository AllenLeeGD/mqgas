...
<html lang="en" class="no-js">
	...
	<body class="page-header-fixed">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title"> 积分设置 <small>设置每次购买煤气瓶的积分值</small></h3>
							<ul class="page-breadcrumb breadcrumb">
								...
								<li>
									<a href="sys_pointset.php?tag=sysadmin&item=3">
										积分设置
									</a>
								</li>
							</ul>
											...
											<form action="javascript:;" class="form-horizontal">
												<div class="form-body" style="padding:16px 26px 16px 26px;">
													<div id="vipdiscountgroup" class="form-group">
														...
														<label class="control-label col-md-2">积分值 <span class="required"> </span> </label>
														<div class="col-md-3">
															<input id="costvalue" type="number" class="form-control input-small"/>
															<span class="help-block"> 例如：10分 </span>
														</div>
		...
		<script src="assets/scripts/admin/sys_pointset.js"></script>
