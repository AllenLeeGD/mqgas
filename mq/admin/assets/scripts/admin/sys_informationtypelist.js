		...
		var grid = new Datatable();
            grid.init({
                ...
                dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options 
                    ...
                    "sAjaxSource": "../index.php/Admin/Admin/findInformationType", // ajax source
                    "bSort":false,//不允许排序
...
function openInformationTypeEdit(pkid,index,txtname) {
...
function doEdit() {
	...
	var util = new Util();
	util.showLoading();
	util.postUrl('/Admin/Admin/saveInformationType/pkid/' + pkid, function(data, status) {
		if (data == "1") {
...
function openInformationTypeDel(pkid,index) {
...
function doDel() {
	...
	var util = new Util();
	util.showLoading();
	util.postUrl('/Admin/Admin/delInformationType/pkid/' + pkid, function(data, status) {
		if (data == "1") {
...
$(document).ready(function() {
	App.init();
	ProductAdd.init("../index.php/Admin/Admin/findInformationType",0);
});