...
<html lang="en" class="no-js">
	...
	<body class="page-header-fixed">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title"> 发放优惠券 <small>设置优惠券有效期、金额和数量</small></h3>
							<ul class="page-breadcrumb breadcrumb">
								...
								<li>
									<a href="sys_couponadd.php?tag=sysadmin&item=1">
										发放优惠券
									</a>
								</li>
							</ul>
						...
						<div class="col-md-12">
							...
							<div class="tab-content">
											...
											<form action="javascript:;" class="form-horizontal">
												<div class="form-body" style="padding:16px 26px 16px 26px;">
													<div id="vipdiscountgroup" class="form-group">
														...
														<label class="control-label col-md-2">金额 <span class="required"> </span> </label>
														<div class="col-md-3">
															<input id="costvalue" type="number" max="20" class="form-control input-small"/>
															<span class="help-block"> 例如：1元、2元、5元、10元 </span>
														</div>
														<label class="control-label col-md-2">数量 <span class="required"> </span> </label>
														<div class="col-md-3">
															<input id="countnumber" type="number" class="form-control input-small"/>
															<span class="help-block"> 例如：1000张 </span>
														</div>
													</div>
													...
													<div id="vipdiscountgroup" class="form-group">
														...
														<label class="control-label col-md-2">会员分组 <span class="required"> </span> </label>
														<div class="col-md-3">
															<div class="input-icon right">
																<select id="type" name="channelid" class="form-control" style="width: ;">
								...
								<div class="col-md-offset-2 col-md-9">
									&nbsp;&nbsp;
									<button id="btnSave" type="submit" data-loading-text="操作中..." class="btn yellow">
									&nbsp;&nbsp;生成优惠券&nbsp;&nbsp;
									</button>
								</div>
							</div>
							<div  class="form-body" style="padding:70px 26px 16px 26px;">
								<div id="couponquery" class="form-group">
		...
		<script src="assets/scripts/admin/sys_couponadd.js"></script>
