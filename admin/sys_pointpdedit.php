...
<html lang="en" class="no-js">
	...
	<body class="page-header-fixed">
								...
								<div class="portlet-body form">
									...
									<form action="javascript:;" class="form-horizontal">
										<div class="form-body" style="padding:16px 26px 16px 26px;">
											<h3 class="form-section">编辑服务项目</h3>
											...
											<div id="remarksgroup" class="form-group">
												...
												<div id="ta" class="col-md-10">
													<textarea id="remarks" class="form-control" name="remarks" rows="6"></textarea>
												</div>
											</div>
		...
		<script src="assets/scripts/admin/sys_pointpdedit.js"></script>
