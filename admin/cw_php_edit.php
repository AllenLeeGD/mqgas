...
<html lang="en" class="no-js">
	...
	<body class="page-header-fixed">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title" id="l_title">  <small id="m_title"></small></h3>
							<ul class="page-breadcrumb breadcrumb">
								...
								<li>
									<a href="cw_php.php?tag=cwadmin&item=1">
										财务瓶换瓶收据管理
									</a>
								</li>
							</ul>
		...
		<script src="assets/scripts/admin/cw_php_edit.js"></script>
