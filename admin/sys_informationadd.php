...
<html lang="en" class="no-js">
	...
	<body class="page-header-fixed">
									...
									<form action="javascript:;" class="form-horizontal">
										<div class="form-body" style="padding:16px 26px 16px 26px;">
											...
											<div id="contentgroup" class="form-group">
												...
												<div class="col-md-10">
													<textarea id="content" class="ckeditor form-control" name="editor2" rows="6" data-error-container="#editor2_error"></textarea>
		...
		<script src="assets/scripts/admin/sys_informationadd.js"></script>
