...
<html lang="en" class="no-js">
	...
	<body class="page-header-fixed">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="page-breadcrumb breadcrumb">
								...
								<li>
									<a href="adminlist.php?tag=sysadmin&item=30"> 管理员设置 </a>
								</li>
							</ul>
									...
									<div class="table-container">
										<table class="table table-bordered table-hover table-custom" id="datatable_orders1">
											<thead>
												...
												<tr role="row">
													<td><input id="username_search" type="text" class="form-control form-filter" style="width: 100%;" name="username_search" placeholder="请输入账号"> </td>
													<td><select id="status_search" name="status_search" class="form-control form-filter  input-inline font-size-12">
													...
													<td>
														<div class="margin-bottom-5 input-inline">
		...
		<script src="assets/scripts/admin/adminlist.js"></script>
		<!-- END JAVASCRIPTS -->
	</body>
	<!-- END BODY -->
