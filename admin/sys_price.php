...
//			}
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title"> 客户价格设置 <small>增加、编辑、删除客户价格信息</small></h3>
							<ul class="page-breadcrumb breadcrumb">
								<li class="btn-group">
									...
									<ul class="dropdown-menu pull-right" role="menu">
										<li>
											<a id="addBtn" href="sys_price_add.php?tag=sysadmin&item=15">
												新增价格信息
											</a>
										</li>
									</ul>
			...
			<script src="assets/scripts/admin/sys_price.js"></script>
