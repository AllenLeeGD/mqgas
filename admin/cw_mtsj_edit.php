...
//			}
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="page-breadcrumb breadcrumb">
								...
								<li>
									<a id="ltitle" href="cw_php.php?tag=cwadmin&item=1">
					...
					<div class="row">
						<div class="col-md-12">
							<ul class="nav nav-tabs">
								<li class="active">
									<a id="a_title" href="#tab_0" data-toggle="tab">
										...
										<div class="portlet-body form">
											...
											<form action="javascript:;" class="form-horizontal">
												<div class="form-body" style="padding:16px 26px 16px 26px;">
													...
													<div id="form_app">
														<div id="vipdiscountgroup" class="form-group">
															<label class="control-label col-md-2">领用部门 <span class="required"> *</span> </label>
															<div class="col-md-8">
																<input id="bname" v-model="sendobj.bname" type="text" class="form-control input-large"/>
														...
														<div id="vipdiscountgroup" class="form-group">
															...
															<div class="col-md-8">
																<input id="snumber" v-model="sendobj.snumber" type="text" class="form-control input-large"/>
																<span class="help-block"> </span>
															</div>
														</div>
														<div id="vipdiscountgroup" class="form-group">
															<label class="control-label col-md-2">状态 <span class="required"> *</span> </label>
															<div class="col-md-8">																
																<select id="status" v-model="sendobj.status" class="form-control  input-large">
														...
														<div id="vipdiscountgroup" class="form-group">
															<label class="control-label col-md-2">领用人 <span class="required"> *</span> </label>
															<div class="col-md-8">
																<input id="lname" v-model="sendobj.lname" type="text" class="form-control input-large"/>
																<span class="help-block"> </span>
															</div>
														</div>
														<div id="vipdiscountgroup" class="form-group">
														...
														<div id="vipdiscountgroup" class="form-group">
															<label class="control-label col-md-2">摘要 <span class="required"> </span> </label>
															<div class="col-md-8">
																<textarea id="msg" v-model="sendobj.msg" rows="10" class="form-control input-large"/></textarea>
																<span class="help-block"> </span>
															</div>
														</div>
														<div id="vipdiscountgroup" class="form-group">
															<label class="control-label col-md-2">使用情况 <span class="required"> </span> </label>
															<div class="col-md-8">
																<textarea id="syqk" v-model="sendobj.syqk" rows="10" class="form-control input-large"/></textarea>																
																<span class="help-block"> </span>
															</div>
														</div>
														<div id="vipdiscountgroup" class="form-group">
		...
		<script src="assets/scripts/admin/cw_mtsj_edit.js"></script>
