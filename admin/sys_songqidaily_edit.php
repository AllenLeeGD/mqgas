...
//			}
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title"> 编辑日常送气工信息 <small>编辑日常送气工信息</small></h3>
										...
										<div class="portlet-body form">
											...
											<form action="javascript:;" class="form-horizontal">
												...
												<div id="vipdiscountgroup" class="form-group">
													...
													<div id="vipdiscountgroup" class="form-group">
														<label class="control-label col-md-2">送气工 <span class="required"> *</span> </label>
														<div class="col-md-8">
															<select id="sid" name="sid" v-model="sendobj.sid" class="form-control input-large">																
																<option v-for="option in songqis" :value="option.pid" v-text="option.realname" >  																																    	   </option>
															</select>
															<span class="help-block">  </span>
														</div>
													</div>
		...
		<script src="assets/scripts/admin/sys_songqidaily_edit.js"></script>
