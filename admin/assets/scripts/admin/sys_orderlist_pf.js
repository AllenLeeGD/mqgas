...
$(document).ready(function() {
	...
	if(util.isNullStr(params)) {
		ProviderOrder.init("../index.php/Mq/Dgsorder/findProductOrderByStatus/status/0", start);
	} else {
	...
	$("#bei_tab").bind('click', function() {
		document.title="票房订单管理";
		ProviderOrder.init("../index.php/Mq/Dgsorder/findProductOrderByStatus/status/2", 0);
	});
	//已完成的订单
