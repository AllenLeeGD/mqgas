...
function openCheck(pid,pname) {
	document.location.href = "sys_check.php?tag=sysadmin&item=13&memberid="+pid+"&membername="+base64_encode(pname);
}

function openRecall(pid,pname) {
...
$(document).ready(function() {
	...
	if(util.isNullStr(params)) {
		ProviderOrder.init("../index.php/Mq/Check/findCheckrecall", start);
	} else {
