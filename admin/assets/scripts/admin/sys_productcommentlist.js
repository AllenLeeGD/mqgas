		...
		var grid = new Datatable();
            grid.init({
                ...
                dataTable: {  // here you can define a typical datatable settings from http://datatables.net/usage/options 
                    ...
                    "sAjaxSource": "../index.php/Admin/Admin/findProductCommentByReview", // ajax source
                    "bSort":false,//不允许排序
...
function openProductCommentDel(pkid,index) {
...
function doDel() {
	...
	var util = new Util();
	util.showLoading();
	util.postUrl('/Admin/Admin/delProductComment/pkid/' + pkid, function(data, status) {
		if (data == "1") {
...
$(document).ready(function() {
	App.init();
	ProductAdd.init("../index.php/Admin/Admin/findProductCommentByReview",0);
});