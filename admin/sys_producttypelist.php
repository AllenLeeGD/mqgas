...
<html lang="en" class="no-js">
	...
	<body class="page-header-fixed">
							...
							<ul class="page-breadcrumb breadcrumb">
								<li class="btn-group">
									...
									<ul class="dropdown-menu pull-right" role="menu">
										<li>
											<a href="sys_producttypeadd.php?tag=sysadmin&item=3">
												新增服务分类
											</a>
										</li>
										<li>
											<a href="sys_producttypelist.php?tag=sysadmin&item=3">
											服务分类管理
											</a>
										</li>
									</ul>
								...
								<li>
									<a href="sys_producttypelist.php?tag=sysadmin&item=3"> 服务分类管理 </a>
								</li>
							</ul>
									...
									<div class="table-container">
										<table class="table table-bordered table-hover table-custom" id="datatable_orders1">
											<thead>
												...
												<tr role="row">
													<td><input id="typename_search" type="text" class="form-control form-filter" name="typename_search" placeholder="分类名称关键字"></td>
													<td>
		...
		<script src="assets/scripts/admin/sys_producttypelist.js"></script>
		<!-- END JAVASCRIPTS -->
	</body>
	<!-- END BODY -->
</html>