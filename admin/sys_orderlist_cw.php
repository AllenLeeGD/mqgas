...
<html lang="en" class="no-js">
	...
	<body class="page-header-fixed">
		...
		<div class="page-container">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title"> 居民小工商订单(财务) <small></small></h3>
							<ul class="page-breadcrumb breadcrumb">
								...
								<li>
									<a href="sys_orderlist_cw.php?tag=productadmin&item=7">
										居民小工商订单(财务)
									</a>
								</li>
							</ul>
			...
			<div class="modal fade" id="do_he" tabindex="-1" role="dialog" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content" style="padding:10px 20px 10px 20px;">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title green">核款</h4>
						</div>
						...
						<form id="form_app" action="javascript:;" class="form-horizontal">
							<div class="form-body" style="padding:16px 26px 16px 26px;">
								<div class="form-group">
									...
									<label class="control-label col-md-4">核实存款信息 <span class="required"> </span> </label>
									<div class="col-md-8">
										<textarea id="hemsg" rows="10" style="width: 300px;" maxlength="120" class="form-control" ></textarea>										
						...
						<div class="modal-footer">
							...
							<button  type="button" class="btn blue" onclick="doHe()">
							确定
							</button>
						</div>
					</div>
			...
			<script src="assets/scripts/admin/sys_orderlist_cw.js"></script>
