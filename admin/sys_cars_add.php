...
//			}
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title"> 新增车辆 <small>增加车辆信息</small></h3>
							<ul class="page-breadcrumb breadcrumb">
								...
								<li>
									<a href="sys_cars.php?tag=sysadmin&item=10">
										车辆设置
									</a>
								</li>
							</ul>
											...
											<form action="javascript:;" class="form-horizontal">
												<div id="form_app" class="form-body" style="padding:16px 26px 16px 26px;">
													<div id="vipdiscountgroup" class="form-group">
														...
														<label class="control-label col-md-2">车辆 <span class="required"> *</span> </label>
														<div class="col-md-8">
															<input id="carnumber" v-model="sendobj.carnumber" type="text" class="form-control input-large"/>
															<span class="help-block"> 例如：粤C12345 </span>
														</div>
													</div>
													<div id="vipdiscountgroup" class="form-group">
		...
		<script src="assets/scripts/admin/sys_cars_add.js"></script>
