...
//			}
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title"> 车辆管理 <small>增加、编辑、删除车辆信息</small></h3>
							<ul class="page-breadcrumb breadcrumb">
								<li class="btn-group">
									...
									<ul class="dropdown-menu pull-right" role="menu">
										<li>
											<a href="sys_cars_add.php?tag=sysadmin&item=10">
												新增车辆
											</a>
										</li>
									</ul>
										...
										<div class="table-container">
											...
											<table class="table table-bordered" id="datatable_orders">
												<thead>
													...
													<tr role="row">
														<td>
															<input id="carnumber_search" type="text" class="form-control form-filter" name="carnumber_search" placeholder="请输入车牌号码">
														</td>
														<td></td>
														<td>
			...
			<script src="assets/scripts/admin/sys_cars.js"></script>
