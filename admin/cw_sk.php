...
<html lang="en" class="no-js">
	...
	<body class="page-header-fixed">
		...
		<div class="page-container">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title"> 财务收款管理 <small>增加、编辑、删除收款信息</small></h3>
							<ul class="page-breadcrumb breadcrumb">
								<li class="btn-group">
									...
									<ul class="dropdown-menu pull-right" role="menu">
										<li>
											<a href="cw_sk_add.php?tag=cwadmin&item=0">
												新增收款信息
											</a>
										</li>
									</ul>
											...
											<table class="table table-bordered" id="datatable_orders">
												<thead>
													<tr role="row" class="heading">
														...
														<th style="width:20%"> 收款时间 </th>
														<th> 金额(元) </th>
														<th style="width:10%"> 操作 </th>
													</tr>
													<tr role="row">
														<td>
															<input id="cname_search" type="text" class="form-control form-filter" name="cname_search" placeholder="请输入客户名称">
														</td>
														<td></td>
														<td>
			...
			<script src="assets/scripts/admin/cw_sk.js"></script>
