...
<html lang="en" class="no-js">
	...
	<body class="page-header-fixed">
										...
										<table class="table table-bordered table-hover table-custom" id="datatable_orders1">
											<thead>
												...
												<tr role="row">
													<td></td>
													<td>
														<input id="title_search" type="text" class="form-control form-filter" name="title_search" placeholder="请输入标题关键字"> 
													</td>
													<td></td>
													<td>
		...
		<script src="assets/scripts/admin/sys_informationlist.js"></script>
		<!-- END JAVASCRIPTS -->
	</body>
	<!-- END BODY -->
</html>