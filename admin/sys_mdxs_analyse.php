...
<html lang="en" class="no-js">
	...
	<body class="page-header-fixed">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title"> 门店销售表 <small>生成门店销售的统计报表</small></h3>
													...
													<div class="form-body" style="padding:16px 26px 16px 26px;">
														<div id="form_app">
															<div id="vipdiscountgroup" class="form-group">
																<label class="control-label col-md-3">门店 <span class="required"> </span> </label>
																<div class="col-md-3">
																	<div class="input-icon right">
																		<select id="departmentid" name="departmentid" v-model="sendobj.departmentid" class="form-control input-middle" style="width: ;">
														...
														<div id="vipdiscountgroup" class="form-group">
															...
															<div class="col-md-3" >
																<div class="input-group input-middle date date-picker" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
															...
															<label class="control-label col-md-3">截止时间 <span class="required"> </span> </label>
															<div class="col-md-3" >
																<div class="input-group input-middle date date-picker" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
		...
		<script src="assets/scripts/admin/sys_mdxs_analyse.js"></script>
