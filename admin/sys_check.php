...
//			}
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title"> 客户安检管理 <small>增加、编辑、删除客户安检信息</small></h3>
											...
											<table class="table table-bordered" id="datatable_orders">
												<thead>
													<tr role="row" class="heading">
														<th style="width:150px"> 安检日期 </th>
														<th> 备注 </th>
														<th style="width:200px"> 操作 </th>
													</tr>
													<tr role="row">
														<td>
															<input id="checkdate_search" type="text" class="form-control form-filter" name="checkdate_search" placeholder="请输入日期">
														</td>
														<td>
														</td>
														<td>
			...
			<script src="assets/scripts/admin/sys_check.js"></script>
